...
var file_hiro_proto_rawDesc = []byte{
	...
	0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79,
	0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0xf0, 0x2b, 0x0a, 0x05, 0x52,
	...
	0x66, 0x69, 0x67, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x4b, 0x0a, 0x1c, 0x52, 0x50, 0x43, 0x5f, 0x49,
...
var file_hiro_proto_goTypes = []any{
	...
	nil,                                              // 186: hiro.AuctionBidAmount.CurrenciesEntry
	nil,                                              // 187: hiro.AuctionTemplateConditionListingCost.CurrenciesEntry
	nil,                                              // 188: hiro.AuctionTemplateConditionListingCost.ItemsEntry
	nil,                                              // 189: hiro.AuctionTemplateConditionListingCost.EnergiesEntry
	nil,                                              // 190: hiro.AuctionTemplate.ConditionsEntry
	nil,                                              // 191: hiro.AuctionTemplates.TemplatesEntry
	nil,                                              // 192: hiro.ProgressionCost.ItemsEntry
	nil,                                              // 193: hiro.ProgressionCost.CurrenciesEntry
	nil,                                              // 194: hiro.ProgressionPreconditions.CountsEntry
	nil,                                              // 195: hiro.ProgressionPreconditions.ItemsMinEntry
	nil,                                              // 196: hiro.ProgressionPreconditions.ItemsMaxEntry
	nil,                                              // 197: hiro.ProgressionPreconditions.StatsMinEntry
	nil,                                              // 198: hiro.ProgressionPreconditions.StatsMaxEntry
	nil,                                              // 199: hiro.ProgressionPreconditions.EnergyMinEntry
	nil,                                              // 200: hiro.ProgressionPreconditions.EnergyMaxEntry
	nil,                                              // 201: hiro.ProgressionPreconditions.CurrencyMinEntry
	nil,                                              // 202: hiro.ProgressionPreconditions.CurrencyMaxEntry
	nil,                                              // 203: hiro.Progression.CountsEntry
	nil,                                              // 204: hiro.Progression.AdditionalPropertiesEntry
	nil,                                              // 205: hiro.ProgressionDelta.CountsEntry
	nil,                                              // 206: hiro.ProgressionList.ProgressionsEntry
	nil,                                              // 207: hiro.ProgressionList.DeltasEntry
	nil,                                              // 208: hiro.ProgressionGetRequest.ProgressionsEntry
	nil,                                              // 209: hiro.ProgressionUpdateRequest.CountsEntry
	nil,                                              // 210: hiro.StatList.PublicEntry
	nil,                                              // 211: hiro.StatList.PrivateEntry
	nil,                                              // 212: hiro.DevicePrefsRequest.PreferencesEntry
	nil,                                              // 213: hiro.RewardInventoryItem.StringPropertiesEntry
	nil,                                              // 214: hiro.RewardInventoryItem.NumericPropertiesEntry
	nil,                                              // 215: hiro.Reward.ItemsEntry
	nil,                                              // 216: hiro.Reward.CurrenciesEntry
	nil,                                              // 217: hiro.Reward.EnergiesEntry
	nil,                                              // 218: hiro.Reward.ItemInstancesEntry
	nil,                                              // 219: hiro.AvailableRewardsStringProperty.OptionsEntry
	nil,                                              // 220: hiro.AvailableRewardsItem.NumericPropertiesEntry
	nil,                                              // 221: hiro.AvailableRewardsItem.StringPropertiesEntry
	nil,                                              // 222: hiro.AvailableRewardsContents.ItemsEntry
	nil,                                              // 223: hiro.AvailableRewardsContents.CurrenciesEntry
	nil,                                              // 224: hiro.AvailableRewardsContents.EnergiesEntry
	nil,                                              // 225: hiro.Incentive.ClaimsEntry
	nil,                                              // 226: hiro.EventLeaderboard.RewardTiersEntry
	nil,                                              // 227: hiro.EventLeaderboard.ChangeZonesEntry
	nil,                                              // 228: hiro.EventLeaderboard.AdditionalPropertiesEntry
	nil,                                              // 229: hiro.EconomyDonation.AdditionalPropertiesEntry
	nil,                                              // 230: hiro.EconomyDonationClaimRewards.ClaimedRewardsEntry
	nil,                                              // 231: hiro.EconomyDonationsByUserList.UserDonationsEntry
	nil,                                              // 232: hiro.EconomyListStoreItemCost.CurrenciesEntry
	nil,                                              // 233: hiro.EconomyListStoreItem.AdditionalPropertiesEntry
	nil,                                              // 234: hiro.EconomyListPlacement.AdditionalPropertiesEntry
	nil,                                              // 235: hiro.EconomyList.DonationsEntry
	nil,                                              // 236: hiro.InventoryItem.StringPropertiesEntry
	nil,                                              // 237: hiro.InventoryItem.NumericPropertiesEntry
	nil,                                              // 238: hiro.InventoryGrantRequest.ItemsEntry
	nil,                                              // 239: hiro.InventoryUpdateItemProperties.StringPropertiesEntry
	nil,                                              // 240: hiro.InventoryUpdateItemProperties.NumericPropertiesEntry
	nil,                                              // 241: hiro.InventoryUpdateItemsRequest.ItemUpdatesEntry
	nil,                                              // 242: hiro.Inventory.ItemsEntry
	nil,                                              // 243: hiro.InventoryConsumeRequest.ItemsEntry
	nil,                                              // 244: hiro.InventoryConsumeRequest.InstancesEntry
	nil,                                              // 245: hiro.InventoryConsumeRewards.RewardsEntry
	nil,                                              // 246: hiro.InventoryConsumeRewards.InstanceRewardsEntry
	nil,                                              // 247: hiro.InventoryList.ItemsEntry
...
var file_hiro_proto_depIdxs = []int32{
	186, // 0: hiro.AuctionBidAmount.currencies:type_name -> hiro.AuctionBidAmount.CurrenciesEntry
	187, // 1: hiro.AuctionTemplateConditionListingCost.currencies:type_name -> hiro.AuctionTemplateConditionListingCost.CurrenciesEntry
	188, // 2: hiro.AuctionTemplateConditionListingCost.items:type_name -> hiro.AuctionTemplateConditionListingCost.ItemsEntry
	189, // 3: hiro.AuctionTemplateConditionListingCost.energies:type_name -> hiro.AuctionTemplateConditionListingCost.EnergiesEntry
	...
	190, // 9: hiro.AuctionTemplate.conditions:type_name -> hiro.AuctionTemplate.ConditionsEntry
	191, // 10: hiro.AuctionTemplates.templates:type_name -> hiro.AuctionTemplates.TemplatesEntry
	...
	192, // 31: hiro.ProgressionCost.items:type_name -> hiro.ProgressionCost.ItemsEntry
	193, // 32: hiro.ProgressionCost.currencies:type_name -> hiro.ProgressionCost.CurrenciesEntry
	194, // 33: hiro.ProgressionPreconditions.counts:type_name -> hiro.ProgressionPreconditions.CountsEntry
	33,  // 34: hiro.ProgressionPreconditions.cost:type_name -> hiro.ProgressionCost
	195, // 35: hiro.ProgressionPreconditions.items_min:type_name -> hiro.ProgressionPreconditions.ItemsMinEntry
	196, // 36: hiro.ProgressionPreconditions.items_max:type_name -> hiro.ProgressionPreconditions.ItemsMaxEntry
	197, // 37: hiro.ProgressionPreconditions.stats_min:type_name -> hiro.ProgressionPreconditions.StatsMinEntry
	198, // 38: hiro.ProgressionPreconditions.stats_max:type_name -> hiro.ProgressionPreconditions.StatsMaxEntry
	199, // 39: hiro.ProgressionPreconditions.energy_min:type_name -> hiro.ProgressionPreconditions.EnergyMinEntry
	200, // 40: hiro.ProgressionPreconditions.energy_max:type_name -> hiro.ProgressionPreconditions.EnergyMaxEntry
	201, // 41: hiro.ProgressionPreconditions.currency_min:type_name -> hiro.ProgressionPreconditions.CurrencyMinEntry
	202, // 42: hiro.ProgressionPreconditions.currency_max:type_name -> hiro.ProgressionPreconditions.CurrencyMaxEntry
	...
	203, // 46: hiro.Progression.counts:type_name -> hiro.Progression.CountsEntry
	204, // 47: hiro.Progression.additional_properties:type_name -> hiro.Progression.AdditionalPropertiesEntry
	...
	205, // 51: hiro.ProgressionDelta.counts:type_name -> hiro.ProgressionDelta.CountsEntry
	35,  // 52: hiro.ProgressionDelta.preconditions:type_name -> hiro.ProgressionPreconditionsBlock
	206, // 53: hiro.ProgressionList.progressions:type_name -> hiro.ProgressionList.ProgressionsEntry
	207, // 54: hiro.ProgressionList.deltas:type_name -> hiro.ProgressionList.DeltasEntry
	208, // 55: hiro.ProgressionGetRequest.progressions:type_name -> hiro.ProgressionGetRequest.ProgressionsEntry
	209, // 56: hiro.ProgressionUpdateRequest.counts:type_name -> hiro.ProgressionUpdateRequest.CountsEntry
	...
	210, // 60: hiro.StatList.public:type_name -> hiro.StatList.PublicEntry
	211, // 61: hiro.StatList.private:type_name -> hiro.StatList.PrivateEntry
	212, // 62: hiro.DevicePrefsRequest.preferences:type_name -> hiro.DevicePrefsRequest.PreferencesEntry
	213, // 63: hiro.RewardInventoryItem.string_properties:type_name -> hiro.RewardInventoryItem.StringPropertiesEntry
	214, // 64: hiro.RewardInventoryItem.numeric_properties:type_name -> hiro.RewardInventoryItem.NumericPropertiesEntry
	215, // 65: hiro.Reward.items:type_name -> hiro.Reward.ItemsEntry
	216, // 66: hiro.Reward.currencies:type_name -> hiro.Reward.CurrenciesEntry
	217, // 67: hiro.Reward.energies:type_name -> hiro.Reward.EnergiesEntry
	...
	218, // 70: hiro.Reward.item_instances:type_name -> hiro.Reward.ItemInstancesEntry
	53,  // 71: hiro.RewardList.rewards:type_name -> hiro.Reward
	219, // 72: hiro.AvailableRewardsStringProperty.options:type_name -> hiro.AvailableRewardsStringProperty.OptionsEntry
	56,  // 73: hiro.AvailableRewardsItem.count:type_name -> hiro.RewardRangeInt64
	220, // 74: hiro.AvailableRewardsItem.numeric_properties:type_name -> hiro.AvailableRewardsItem.NumericPropertiesEntry
	221, // 75: hiro.AvailableRewardsItem.string_properties:type_name -> hiro.AvailableRewardsItem.StringPropertiesEntry
	...
	222, // 83: hiro.AvailableRewardsContents.items:type_name -> hiro.AvailableRewardsContents.ItemsEntry
	62,  // 84: hiro.AvailableRewardsContents.item_sets:type_name -> hiro.AvailableRewardsItemSet
	223, // 85: hiro.AvailableRewardsContents.currencies:type_name -> hiro.AvailableRewardsContents.CurrenciesEntry
	224, // 86: hiro.AvailableRewardsContents.energies:type_name -> hiro.AvailableRewardsContents.EnergiesEntry
	...
	225, // 96: hiro.Incentive.claims:type_name -> hiro.Incentive.ClaimsEntry
	...
	226, // 104: hiro.EventLeaderboard.reward_tiers:type_name -> hiro.EventLeaderboard.RewardTiersEntry
	227, // 105: hiro.EventLeaderboard.change_zones:type_name -> hiro.EventLeaderboard.ChangeZonesEntry
	53,  // 106: hiro.EventLeaderboard.reward:type_name -> hiro.Reward
	228, // 107: hiro.EventLeaderboard.additional_properties:type_name -> hiro.EventLeaderboard.AdditionalPropertiesEntry
	82,  // 108: hiro.EventLeaderboard.scores:type_name -> hiro.EventLeaderboardScore
	288, // 109: hiro.EventLeaderboard.matchmaker_properties:type_name -> google.protobuf.Struct
	289, // 110: hiro.EventLeaderboardDebugRandomScoresRequest.operator:type_name -> google.protobuf.Int32Value
	...
	229, // 115: hiro.EconomyDonation.additional_properties:type_name -> hiro.EconomyDonation.AdditionalPropertiesEntry
	...
	230, // 119: hiro.EconomyDonationClaimRewards.claimed_rewards:type_name -> hiro.EconomyDonationClaimRewards.ClaimedRewardsEntry
	231, // 120: hiro.EconomyDonationsByUserList.user_donations:type_name -> hiro.EconomyDonationsByUserList.UserDonationsEntry
	232, // 121: hiro.EconomyListStoreItemCost.currencies:type_name -> hiro.EconomyListStoreItemCost.CurrenciesEntry
	...
	233, // 124: hiro.EconomyListStoreItem.additional_properties:type_name -> hiro.EconomyListStoreItem.AdditionalPropertiesEntry
	...
	234, // 127: hiro.EconomyListPlacement.additional_properties:type_name -> hiro.EconomyListPlacement.AdditionalPropertiesEntry
	...
	235, // 130: hiro.EconomyList.donations:type_name -> hiro.EconomyList.DonationsEntry
	...
	236, // 133: hiro.InventoryItem.string_properties:type_name -> hiro.InventoryItem.StringPropertiesEntry
	237, // 134: hiro.InventoryItem.numeric_properties:type_name -> hiro.InventoryItem.NumericPropertiesEntry
	238, // 135: hiro.InventoryGrantRequest.items:type_name -> hiro.InventoryGrantRequest.ItemsEntry
	239, // 136: hiro.InventoryUpdateItemProperties.string_properties:type_name -> hiro.InventoryUpdateItemProperties.StringPropertiesEntry
	240, // 137: hiro.InventoryUpdateItemProperties.numeric_properties:type_name -> hiro.InventoryUpdateItemProperties.NumericPropertiesEntry
	241, // 138: hiro.InventoryUpdateItemsRequest.item_updates:type_name -> hiro.InventoryUpdateItemsRequest.ItemUpdatesEntry
	242, // 139: hiro.Inventory.items:type_name -> hiro.Inventory.ItemsEntry
	243, // 140: hiro.InventoryConsumeRequest.items:type_name -> hiro.InventoryConsumeRequest.ItemsEntry
	244, // 141: hiro.InventoryConsumeRequest.instances:type_name -> hiro.InventoryConsumeRequest.InstancesEntry
	108, // 142: hiro.InventoryConsumeRewards.inventory:type_name -> hiro.Inventory
	245, // 143: hiro.InventoryConsumeRewards.rewards:type_name -> hiro.InventoryConsumeRewards.RewardsEntry
	246, // 144: hiro.InventoryConsumeRewards.instance_rewards:type_name -> hiro.InventoryConsumeRewards.InstanceRewardsEntry
	108, // 145: hiro.InventoryUpdateAck.inventory:type_name -> hiro.Inventory
	247, // 146: hiro.InventoryList.items:type_name -> hiro.InventoryList.ItemsEntry
	...
	68,  // 206: hiro.StreakAvailableReward.reward:type_name -> hiro.AvailableRewards
	53,  // 207: hiro.StreakReward.reward:type_name -> hiro.Reward
	...
	52,  // 217: hiro.SyncEconomy.modifiers:type_name -> hiro.ActiveRewardModifier
	...
	33,  // 223: hiro.SyncProgressionUpdate.cost:type_name -> hiro.ProgressionCost
	...
	44,  // 235: hiro.SyncRequest.stats:type_name -> hiro.StatUpdateRequest
	...
	108, // 240: hiro.SyncResponse.inventory:type_name -> hiro.Inventory
	...
	86,  // 243: hiro.SyncResponse.event_leaderboards:type_name -> hiro.EventLeaderboard
	38,  // 244: hiro.SyncResponse.progressions:type_name -> hiro.ProgressionList
	46,  // 245: hiro.SyncResponse.stats:type_name -> hiro.StatList
	...
	52,  // 248: hiro.SyncResponse.active_reward_modifiers:type_name -> hiro.ActiveRewardModifier
	164, // 249: hiro.SyncResponse.streaks:type_name -> hiro.StreaksList
	11,  // 250: hiro.AuctionTemplate.ConditionsEntry.value:type_name -> hiro.AuctionTemplateCondition
	12,  // 251: hiro.AuctionTemplates.TemplatesEntry.value:type_name -> hiro.AuctionTemplate
	36,  // 252: hiro.ProgressionList.ProgressionsEntry.value:type_name -> hiro.Progression
	37,  // 253: hiro.ProgressionList.DeltasEntry.value:type_name -> hiro.ProgressionDelta
	36,  // 254: hiro.ProgressionGetRequest.ProgressionsEntry.value:type_name -> hiro.Progression
	45,  // 255: hiro.StatList.PublicEntry.value:type_name -> hiro.Stat
	45,  // 256: hiro.StatList.PrivateEntry.value:type_name -> hiro.Stat
	49,  // 257: hiro.Reward.ItemInstancesEntry.value:type_name -> hiro.RewardInventoryItem
	59,  // 258: hiro.AvailableRewardsStringProperty.OptionsEntry.value:type_name -> hiro.AvailableRewardsStringPropertyOption
	58,  // 259: hiro.AvailableRewardsItem.NumericPropertiesEntry.value:type_name -> hiro.RewardRangeDouble
	60,  // 260: hiro.AvailableRewardsItem.StringPropertiesEntry.value:type_name -> hiro.AvailableRewardsStringProperty
	61,  // 261: hiro.AvailableRewardsContents.ItemsEntry.value:type_name -> hiro.AvailableRewardsItem
	63,  // 262: hiro.AvailableRewardsContents.CurrenciesEntry.value:type_name -> hiro.AvailableRewardsCurrency
	64,  // 263: hiro.AvailableRewardsContents.EnergiesEntry.value:type_name -> hiro.AvailableRewardsEnergy
	69,  // 264: hiro.Incentive.ClaimsEntry.value:type_name -> hiro.IncentiveClaim
	84,  // 265: hiro.EventLeaderboard.RewardTiersEntry.value:type_name -> hiro.EventLeaderboardRewardTiers
	85,  // 266: hiro.EventLeaderboard.ChangeZonesEntry.value:type_name -> hiro.EventLeaderboardChangeZone
	54,  // 267: hiro.EconomyDonationClaimRewards.ClaimedRewardsEntry.value:type_name -> hiro.RewardList
	92,  // 268: hiro.EconomyDonationsByUserList.UserDonationsEntry.value:type_name -> hiro.EconomyDonationsList
	90,  // 269: hiro.EconomyList.DonationsEntry.value:type_name -> hiro.EconomyDonation
	106, // 270: hiro.InventoryUpdateItemsRequest.ItemUpdatesEntry.value:type_name -> hiro.InventoryUpdateItemProperties
	103, // 271: hiro.Inventory.ItemsEntry.value:type_name -> hiro.InventoryItem
	54,  // 272: hiro.InventoryConsumeRewards.RewardsEntry.value:type_name -> hiro.RewardList
	54,  // 273: hiro.InventoryConsumeRewards.InstanceRewardsEntry.value:type_name -> hiro.RewardList
	103, // 274: hiro.InventoryList.ItemsEntry.value:type_name -> hiro.InventoryItem
