...
var file_hiro_proto_rawDesc = []byte{
	...
	0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03,
	0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0x91, 0x22,
...
var file_hiro_proto_msgTypes = make([]protoimpl.MessageInfo, 229)
var file_hiro_proto_goTypes = []interface{}{
	...
	(*SubAchievement)(nil),                           // 122: hiro.SubAchievement
	(*Achievement)(nil),                              // 123: hiro.Achievement
	(*AchievementList)(nil),                          // 124: hiro.AchievementList
	(*AchievementsClaimRequest)(nil),                 // 125: hiro.AchievementsClaimRequest
	(*AchievementsGetRequest)(nil),                   // 126: hiro.AchievementsGetRequest
	(*AchievementsUpdateAck)(nil),                    // 127: hiro.AchievementsUpdateAck
	(*AchievementsUpdateRequest)(nil),                // 128: hiro.AchievementsUpdateRequest
	(*SyncInventoryItem)(nil),                        // 129: hiro.SyncInventoryItem
	(*SyncInventory)(nil),                            // 130: hiro.SyncInventory
	(*SyncEconomyModifier)(nil),                      // 131: hiro.SyncEconomyModifier
	(*SyncEconomy)(nil),                              // 132: hiro.SyncEconomy
	(*SyncAchievementsUpdate)(nil),                   // 133: hiro.SyncAchievementsUpdate
	(*SyncAchievements)(nil),                         // 134: hiro.SyncAchievements
	(*SyncEnergyState)(nil),                          // 135: hiro.SyncEnergyState
	(*SyncEnergy)(nil),                               // 136: hiro.SyncEnergy
	(*SyncEventLeaderboardUpdate)(nil),               // 137: hiro.SyncEventLeaderboardUpdate
	(*SyncEventLeaderboards)(nil),                    // 138: hiro.SyncEventLeaderboards
	(*SyncProgressionUpdate)(nil),                    // 139: hiro.SyncProgressionUpdate
	(*SyncProgressions)(nil),                         // 140: hiro.SyncProgressions
	(*SyncTutorials)(nil),                            // 141: hiro.SyncTutorials
	(*SyncUnlockableUpdate)(nil),                     // 142: hiro.SyncUnlockableUpdate
	(*SyncUnlockables)(nil),                          // 143: hiro.SyncUnlockables
	(*SyncRequest)(nil),                              // 144: hiro.SyncRequest
	(*SyncResponse)(nil),                             // 145: hiro.SyncResponse
	nil,                                              // 146: hiro.ProgressionCost.ItemsEntry
	nil,                                              // 147: hiro.ProgressionCost.CurrenciesEntry
	nil,                                              // 148: hiro.ProgressionPreconditions.CountsEntry
	nil,                                              // 149: hiro.ProgressionPreconditions.ItemsMinEntry
	nil,                                              // 150: hiro.ProgressionPreconditions.ItemsMaxEntry
	nil,                                              // 151: hiro.ProgressionPreconditions.StatsMinEntry
	nil,                                              // 152: hiro.ProgressionPreconditions.StatsMaxEntry
	nil,                                              // 153: hiro.ProgressionPreconditions.EnergyMinEntry
	nil,                                              // 154: hiro.ProgressionPreconditions.EnergyMaxEntry
	nil,                                              // 155: hiro.ProgressionPreconditions.CurrencyMinEntry
	nil,                                              // 156: hiro.ProgressionPreconditions.CurrencyMaxEntry
	nil,                                              // 157: hiro.Progression.CountsEntry
	nil,                                              // 158: hiro.Progression.AdditionalPropertiesEntry
	nil,                                              // 159: hiro.ProgressionDelta.CountsEntry
	nil,                                              // 160: hiro.ProgressionList.ProgressionsEntry
	nil,                                              // 161: hiro.ProgressionList.DeltasEntry
	nil,                                              // 162: hiro.ProgressionGetRequest.ProgressionsEntry
	nil,                                              // 163: hiro.ProgressionUpdateRequest.CountsEntry
	nil,                                              // 164: hiro.StatList.PublicEntry
	nil,                                              // 165: hiro.StatList.PrivateEntry
	nil,                                              // 166: hiro.DevicePrefsRequest.PreferencesEntry
	nil,                                              // 167: hiro.RewardInventoryItem.StringPropertiesEntry
	nil,                                              // 168: hiro.RewardInventoryItem.NumericPropertiesEntry
	nil,                                              // 169: hiro.Reward.ItemsEntry
	nil,                                              // 170: hiro.Reward.CurrenciesEntry
	nil,                                              // 171: hiro.Reward.EnergiesEntry
	nil,                                              // 172: hiro.Reward.ItemInstancesEntry
	nil,                                              // 173: hiro.AvailableRewardsStringProperty.OptionsEntry
	nil,                                              // 174: hiro.AvailableRewardsItem.NumericPropertiesEntry
	nil,                                              // 175: hiro.AvailableRewardsItem.StringPropertiesEntry
	nil,                                              // 176: hiro.AvailableRewardsContents.ItemsEntry
	nil,                                              // 177: hiro.AvailableRewardsContents.CurrenciesEntry
	nil,                                              // 178: hiro.AvailableRewardsContents.EnergiesEntry
	nil,                                              // 179: hiro.Incentive.ClaimsEntry
	nil,                                              // 180: hiro.EventLeaderboard.RewardTiersEntry
	nil,                                              // 181: hiro.EventLeaderboard.ChangeZonesEntry
	nil,                                              // 182: hiro.EventLeaderboard.AdditionalPropertiesEntry
	nil,                                              // 183: hiro.EconomyDonation.AdditionalPropertiesEntry
	nil,                                              // 184: hiro.EconomyDonationClaimRewards.ClaimedRewardsEntry
	nil,                                              // 185: hiro.EconomyDonationsByUserList.UserDonationsEntry
	nil,                                              // 186: hiro.EconomyListStoreItemCost.CurrenciesEntry
	nil,                                              // 187: hiro.EconomyListStoreItem.AdditionalPropertiesEntry
	nil,                                              // 188: hiro.EconomyListPlacement.AdditionalPropertiesEntry
	nil,                                              // 189: hiro.EconomyList.DonationsEntry
	nil,                                              // 190: hiro.InventoryItem.StringPropertiesEntry
	nil,                                              // 191: hiro.InventoryItem.NumericPropertiesEntry
	nil,                                              // 192: hiro.InventoryGrantRequest.ItemsEntry
	nil,                                              // 193: hiro.InventoryUpdateItemProperties.StringPropertiesEntry
	nil,                                              // 194: hiro.InventoryUpdateItemProperties.NumericPropertiesEntry
	nil,                                              // 195: hiro.InventoryUpdateItemsRequest.ItemUpdatesEntry
	nil,                                              // 196: hiro.Inventory.ItemsEntry
	nil,                                              // 197: hiro.InventoryConsumeRequest.ItemsEntry
	nil,                                              // 198: hiro.InventoryConsumeRequest.InstancesEntry
	nil,                                              // 199: hiro.InventoryConsumeRewards.RewardsEntry
	nil,                                              // 200: hiro.InventoryConsumeRewards.InstanceRewardsEntry
	nil,                                              // 201: hiro.InventoryList.ItemsEntry
	nil,                                              // 202: hiro.EconomyGrantRequest.CurrenciesEntry
	nil,                                              // 203: hiro.EconomyGrantRequest.ItemsEntry
	nil,                                              // 204: hiro.EconomyUpdateAck.WalletEntry
	nil,                                              // 205: hiro.EconomyPurchaseAck.WalletEntry
	nil,                                              // 206: hiro.Energy.AdditionalPropertiesEntry
	nil,                                              // 207: hiro.EnergyList.EnergiesEntry
	nil,                                              // 208: hiro.EnergySpendRequest.AmountsEntry
	nil,                                              // 209: hiro.Tutorial.AdditionalPropertiesEntry
	nil,                                              // 210: hiro.TutorialList.TutorialsEntry
	...
	nil,                                              // 224: hiro.SyncInventoryItem.StringPropertiesEntry
	nil,                                              // 225: hiro.SyncInventoryItem.NumericPropertiesEntry
	nil,                                              // 226: hiro.SyncInventory.ItemsEntry
	nil,                                              // 227: hiro.SyncEconomy.CurrenciesEntry
	nil,                                              // 228: hiro.SyncAchievements.AchievementsEntry
	nil,                                              // 229: hiro.SyncEnergy.EnergiesEntry
	nil,                                              // 230: hiro.SyncEventLeaderboards.EventLeaderboardsEntry
	nil,                                              // 231: hiro.SyncProgressionUpdate.CountsEntry
	nil,                                              // 232: hiro.SyncProgressions.ProgressionsEntry
	nil,                                              // 233: hiro.SyncTutorials.UpdatesEntry
	nil,                                              // 234: hiro.SyncUnlockables.UpdatesEntry
	nil,                                              // 235: hiro.SyncResponse.WalletEntry
	(*structpb.Struct)(nil),                          // 236: google.protobuf.Struct
	(*wrapperspb.Int32Value)(nil),                    // 237: google.protobuf.Int32Value
	(*descriptorpb.EnumValueOptions)(nil),            // 238: google.protobuf.EnumValueOptions
}
var file_hiro_proto_depIdxs = []int32{
	146, // 0: hiro.ProgressionCost.items:type_name -> hiro.ProgressionCost.ItemsEntry
	147, // 1: hiro.ProgressionCost.currencies:type_name -> hiro.ProgressionCost.CurrenciesEntry
	148, // 2: hiro.ProgressionPreconditions.counts:type_name -> hiro.ProgressionPreconditions.CountsEntry
	7,   // 3: hiro.ProgressionPreconditions.cost:type_name -> hiro.ProgressionCost
	149, // 4: hiro.ProgressionPreconditions.items_min:type_name -> hiro.ProgressionPreconditions.ItemsMinEntry
	150, // 5: hiro.ProgressionPreconditions.items_max:type_name -> hiro.ProgressionPreconditions.ItemsMaxEntry
	151, // 6: hiro.ProgressionPreconditions.stats_min:type_name -> hiro.ProgressionPreconditions.StatsMinEntry
	152, // 7: hiro.ProgressionPreconditions.stats_max:type_name -> hiro.ProgressionPreconditions.StatsMaxEntry
	153, // 8: hiro.ProgressionPreconditions.energy_min:type_name -> hiro.ProgressionPreconditions.EnergyMinEntry
	154, // 9: hiro.ProgressionPreconditions.energy_max:type_name -> hiro.ProgressionPreconditions.EnergyMaxEntry
	155, // 10: hiro.ProgressionPreconditions.currency_min:type_name -> hiro.ProgressionPreconditions.CurrencyMinEntry
	156, // 11: hiro.ProgressionPreconditions.currency_max:type_name -> hiro.ProgressionPreconditions.CurrencyMaxEntry
	...
	157, // 15: hiro.Progression.counts:type_name -> hiro.Progression.CountsEntry
	158, // 16: hiro.Progression.additional_properties:type_name -> hiro.Progression.AdditionalPropertiesEntry
	...
	159, // 20: hiro.ProgressionDelta.counts:type_name -> hiro.ProgressionDelta.CountsEntry
	9,   // 21: hiro.ProgressionDelta.preconditions:type_name -> hiro.ProgressionPreconditionsBlock
	160, // 22: hiro.ProgressionList.progressions:type_name -> hiro.ProgressionList.ProgressionsEntry
	161, // 23: hiro.ProgressionList.deltas:type_name -> hiro.ProgressionList.DeltasEntry
	162, // 24: hiro.ProgressionGetRequest.progressions:type_name -> hiro.ProgressionGetRequest.ProgressionsEntry
	163, // 25: hiro.ProgressionUpdateRequest.counts:type_name -> hiro.ProgressionUpdateRequest.CountsEntry
	...
	164, // 29: hiro.StatList.public:type_name -> hiro.StatList.PublicEntry
	165, // 30: hiro.StatList.private:type_name -> hiro.StatList.PrivateEntry
	166, // 31: hiro.DevicePrefsRequest.preferences:type_name -> hiro.DevicePrefsRequest.PreferencesEntry
	167, // 32: hiro.RewardInventoryItem.string_properties:type_name -> hiro.RewardInventoryItem.StringPropertiesEntry
	168, // 33: hiro.RewardInventoryItem.numeric_properties:type_name -> hiro.RewardInventoryItem.NumericPropertiesEntry
	169, // 34: hiro.Reward.items:type_name -> hiro.Reward.ItemsEntry
	170, // 35: hiro.Reward.currencies:type_name -> hiro.Reward.CurrenciesEntry
	171, // 36: hiro.Reward.energies:type_name -> hiro.Reward.EnergiesEntry
	...
	172, // 39: hiro.Reward.item_instances:type_name -> hiro.Reward.ItemInstancesEntry
	26,  // 40: hiro.RewardList.rewards:type_name -> hiro.Reward
	173, // 41: hiro.AvailableRewardsStringProperty.options:type_name -> hiro.AvailableRewardsStringProperty.OptionsEntry
	29,  // 42: hiro.AvailableRewardsItem.count:type_name -> hiro.RewardRangeInt64
	174, // 43: hiro.AvailableRewardsItem.numeric_properties:type_name -> hiro.AvailableRewardsItem.NumericPropertiesEntry
	175, // 44: hiro.AvailableRewardsItem.string_properties:type_name -> hiro.AvailableRewardsItem.StringPropertiesEntry
	...
	176, // 52: hiro.AvailableRewardsContents.items:type_name -> hiro.AvailableRewardsContents.ItemsEntry
	35,  // 53: hiro.AvailableRewardsContents.item_sets:type_name -> hiro.AvailableRewardsItemSet
	177, // 54: hiro.AvailableRewardsContents.currencies:type_name -> hiro.AvailableRewardsContents.CurrenciesEntry
	178, // 55: hiro.AvailableRewardsContents.energies:type_name -> hiro.AvailableRewardsContents.EnergiesEntry
	...
	179, // 65: hiro.Incentive.claims:type_name -> hiro.Incentive.ClaimsEntry
	...
	180, // 73: hiro.EventLeaderboard.reward_tiers:type_name -> hiro.EventLeaderboard.RewardTiersEntry
	181, // 74: hiro.EventLeaderboard.change_zones:type_name -> hiro.EventLeaderboard.ChangeZonesEntry
	26,  // 75: hiro.EventLeaderboard.reward:type_name -> hiro.Reward
	182, // 76: hiro.EventLeaderboard.additional_properties:type_name -> hiro.EventLeaderboard.AdditionalPropertiesEntry
	55,  // 77: hiro.EventLeaderboard.scores:type_name -> hiro.EventLeaderboardScore
	236, // 78: hiro.EventLeaderboard.matchmaker_properties:type_name -> google.protobuf.Struct
	237, // 79: hiro.EventLeaderboardDebugRandomScoresRequest.operator:type_name -> google.protobuf.Int32Value
	...
	183, // 84: hiro.EconomyDonation.additional_properties:type_name -> hiro.EconomyDonation.AdditionalPropertiesEntry
	...
	184, // 88: hiro.EconomyDonationClaimRewards.claimed_rewards:type_name -> hiro.EconomyDonationClaimRewards.ClaimedRewardsEntry
	185, // 89: hiro.EconomyDonationsByUserList.user_donations:type_name -> hiro.EconomyDonationsByUserList.UserDonationsEntry
	186, // 90: hiro.EconomyListStoreItemCost.currencies:type_name -> hiro.EconomyListStoreItemCost.CurrenciesEntry
	...
	187, // 93: hiro.EconomyListStoreItem.additional_properties:type_name -> hiro.EconomyListStoreItem.AdditionalPropertiesEntry
	...
	188, // 96: hiro.EconomyListPlacement.additional_properties:type_name -> hiro.EconomyListPlacement.AdditionalPropertiesEntry
	...
	189, // 99: hiro.EconomyList.donations:type_name -> hiro.EconomyList.DonationsEntry
	41,  // 100: hiro.InventoryItem.consume_available_rewards:type_name -> hiro.AvailableRewards
	190, // 101: hiro.InventoryItem.string_properties:type_name -> hiro.InventoryItem.StringPropertiesEntry
	191, // 102: hiro.InventoryItem.numeric_properties:type_name -> hiro.InventoryItem.NumericPropertiesEntry
	192, // 103: hiro.InventoryGrantRequest.items:type_name -> hiro.InventoryGrantRequest.ItemsEntry
	193, // 104: hiro.InventoryUpdateItemProperties.string_properties:type_name -> hiro.InventoryUpdateItemProperties.StringPropertiesEntry
	194, // 105: hiro.InventoryUpdateItemProperties.numeric_properties:type_name -> hiro.InventoryUpdateItemProperties.NumericPropertiesEntry
	195, // 106: hiro.InventoryUpdateItemsRequest.item_updates:type_name -> hiro.InventoryUpdateItemsRequest.ItemUpdatesEntry
	196, // 107: hiro.Inventory.items:type_name -> hiro.Inventory.ItemsEntry
	197, // 108: hiro.InventoryConsumeRequest.items:type_name -> hiro.InventoryConsumeRequest.ItemsEntry
	198, // 109: hiro.InventoryConsumeRequest.instances:type_name -> hiro.InventoryConsumeRequest.InstancesEntry
	81,  // 110: hiro.InventoryConsumeRewards.inventory:type_name -> hiro.Inventory
	199, // 111: hiro.InventoryConsumeRewards.rewards:type_name -> hiro.InventoryConsumeRewards.RewardsEntry
	200, // 112: hiro.InventoryConsumeRewards.instance_rewards:type_name -> hiro.InventoryConsumeRewards.InstanceRewardsEntry
	81,  // 113: hiro.InventoryUpdateAck.inventory:type_name -> hiro.Inventory
	201, // 114: hiro.InventoryList.items:type_name -> hiro.InventoryList.ItemsEntry
	4,   // 115: hiro.EconomyListRequest.store_type:type_name -> hiro.EconomyStoreType
	202, // 116: hiro.EconomyGrantRequest.currencies:type_name -> hiro.EconomyGrantRequest.CurrenciesEntry
	25,  // 117: hiro.EconomyGrantRequest.reward_modifiers:type_name -> hiro.RewardModifier
	203, // 118: hiro.EconomyGrantRequest.items:type_name -> hiro.EconomyGrantRequest.ItemsEntry
	...
	204, // 123: hiro.EconomyUpdateAck.wallet:type_name -> hiro.EconomyUpdateAck.WalletEntry
	81,  // 124: hiro.EconomyUpdateAck.inventory:type_name -> hiro.Inventory
	26,  // 125: hiro.EconomyUpdateAck.reward:type_name -> hiro.Reward
	205, // 126: hiro.EconomyPurchaseAck.wallet:type_name -> hiro.EconomyPurchaseAck.WalletEntry
	...
	206, // 131: hiro.Energy.additional_properties:type_name -> hiro.Energy.AdditionalPropertiesEntry
	207, // 132: hiro.EnergyList.energies:type_name -> hiro.EnergyList.EnergiesEntry
	208, // 133: hiro.EnergySpendRequest.amounts:type_name -> hiro.EnergySpendRequest.AmountsEntry
	...
	209, // 138: hiro.Tutorial.additional_properties:type_name -> hiro.Tutorial.AdditionalPropertiesEntry
	210, // 139: hiro.TutorialList.tutorials:type_name -> hiro.TutorialList.TutorialsEntry
	110, // 140: hiro.TeamList.teams:type_name -> hiro.Team
	211, // 141: hiro.UnlockableCost.items:type_name -> hiro.UnlockableCost.ItemsEntry
	212, // 142: hiro.UnlockableCost.currencies:type_name -> hiro.UnlockableCost.CurrenciesEntry
	...
	213, // 147: hiro.Unlockable.additional_properties:type_name -> hiro.Unlockable.AdditionalPropertiesEntry
	214, // 148: hiro.UnlockableSlotCost.items:type_name -> hiro.UnlockableSlotCost.ItemsEntry
	215, // 149: hiro.UnlockableSlotCost.currencies:type_name -> hiro.UnlockableSlotCost.CurrenciesEntry
	...
	216, // 158: hiro.SubAchievement.additional_properties:type_name -> hiro.SubAchievement.AdditionalPropertiesEntry
	...
	217, // 163: hiro.Achievement.sub_achievements:type_name -> hiro.Achievement.SubAchievementsEntry
	218, // 164: hiro.Achievement.additional_properties:type_name -> hiro.Achievement.AdditionalPropertiesEntry
	219, // 165: hiro.AchievementList.achievements:type_name -> hiro.AchievementList.AchievementsEntry
	220, // 166: hiro.AchievementList.repeat_achievements:type_name -> hiro.AchievementList.RepeatAchievementsEntry
	221, // 167: hiro.AchievementsUpdateAck.achievements:type_name -> hiro.AchievementsUpdateAck.AchievementsEntry
	222, // 168: hiro.AchievementsUpdateAck.repeat_achievements:type_name -> hiro.AchievementsUpdateAck.RepeatAchievementsEntry
	223, // 169: hiro.AchievementsUpdateRequest.achievements:type_name -> hiro.AchievementsUpdateRequest.AchievementsEntry
	224, // 170: hiro.SyncInventoryItem.string_properties:type_name -> hiro.SyncInventoryItem.StringPropertiesEntry
	225, // 171: hiro.SyncInventoryItem.numeric_properties:type_name -> hiro.SyncInventoryItem.NumericPropertiesEntry
	226, // 172: hiro.SyncInventory.items:type_name -> hiro.SyncInventory.ItemsEntry
	25,  // 173: hiro.SyncEconomyModifier.modifier:type_name -> hiro.RewardModifier
	227, // 174: hiro.SyncEconomy.currencies:type_name -> hiro.SyncEconomy.CurrenciesEntry
	131, // 175: hiro.SyncEconomy.modifiers:type_name -> hiro.SyncEconomyModifier
	228, // 176: hiro.SyncAchievements.achievements:type_name -> hiro.SyncAchievements.AchievementsEntry
	229, // 177: hiro.SyncEnergy.energies:type_name -> hiro.SyncEnergy.EnergiesEntry
	96,  // 178: hiro.SyncEnergy.modifiers:type_name -> hiro.EnergyModifier
	230, // 179: hiro.SyncEventLeaderboards.event_leaderboards:type_name -> hiro.SyncEventLeaderboards.EventLeaderboardsEntry
	231, // 180: hiro.SyncProgressionUpdate.counts:type_name -> hiro.SyncProgressionUpdate.CountsEntry
	7,   // 181: hiro.SyncProgressionUpdate.cost:type_name -> hiro.ProgressionCost
	232, // 182: hiro.SyncProgressions.progressions:type_name -> hiro.SyncProgressions.ProgressionsEntry
	233, // 183: hiro.SyncTutorials.updates:type_name -> hiro.SyncTutorials.UpdatesEntry
	234, // 184: hiro.SyncUnlockables.updates:type_name -> hiro.SyncUnlockables.UpdatesEntry
	130, // 185: hiro.SyncRequest.inventory:type_name -> hiro.SyncInventory
	132, // 186: hiro.SyncRequest.economy:type_name -> hiro.SyncEconomy
	134, // 187: hiro.SyncRequest.achievements:type_name -> hiro.SyncAchievements
	136, // 188: hiro.SyncRequest.energy:type_name -> hiro.SyncEnergy
	138, // 189: hiro.SyncRequest.event_leaderboards:type_name -> hiro.SyncEventLeaderboards
	140, // 190: hiro.SyncRequest.progressions:type_name -> hiro.SyncProgressions
	18,  // 191: hiro.SyncRequest.stats:type_name -> hiro.StatUpdateRequest
	141, // 192: hiro.SyncRequest.tutorials:type_name -> hiro.SyncTutorials
	143, // 193: hiro.SyncRequest.unlockables:type_name -> hiro.SyncUnlockables
	235, // 194: hiro.SyncResponse.wallet:type_name -> hiro.SyncResponse.WalletEntry
	81,  // 195: hiro.SyncResponse.inventory:type_name -> hiro.Inventory
	124, // 196: hiro.SyncResponse.achievements:type_name -> hiro.AchievementList
	...
	122, // 228: hiro.Achievement.SubAchievementsEntry.value:type_name -> hiro.SubAchievement
	123, // 229: hiro.AchievementList.AchievementsEntry.value:type_name -> hiro.Achievement
	123, // 230: hiro.AchievementList.RepeatAchievementsEntry.value:type_name -> hiro.Achievement
	123, // 231: hiro.AchievementsUpdateAck.AchievementsEntry.value:type_name -> hiro.Achievement
	123, // 232: hiro.AchievementsUpdateAck.RepeatAchievementsEntry.value:type_name -> hiro.Achievement
	129, // 233: hiro.SyncInventory.ItemsEntry.value:type_name -> hiro.SyncInventoryItem
	133, // 234: hiro.SyncAchievements.AchievementsEntry.value:type_name -> hiro.SyncAchievementsUpdate
	135, // 235: hiro.SyncEnergy.EnergiesEntry.value:type_name -> hiro.SyncEnergyState
	137, // 236: hiro.SyncEventLeaderboards.EventLeaderboardsEntry.value:type_name -> hiro.SyncEventLeaderboardUpdate
	139, // 237: hiro.SyncProgressions.ProgressionsEntry.value:type_name -> hiro.SyncProgressionUpdate
	142, // 238: hiro.SyncUnlockables.UpdatesEntry.value:type_name -> hiro.SyncUnlockableUpdate
	238, // 239: hiro.input:extendee -> google.protobuf.EnumValueOptions
	238, // 240: hiro.output:extendee -> google.protobuf.EnumValueOptions
