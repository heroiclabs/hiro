...
type AuctionsSystem interface {
	...
	List(ctx context.Context, logger runtime.Logger, nk runtime.NakamaModule, userID, query string, allowedOnly bool, sort []string, limit int, cursor string) (*AuctionList, error)
