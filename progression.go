...
type ProgressionSystem interface {
	...
	UpdateProgression(ctx context.Context, logger runtime.Logger, nk runtime.NakamaModule, userID, progressionID string, amount int64, autoClaim bool) (map[string]*Progression, error)
