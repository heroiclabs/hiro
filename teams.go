...
type TeamsSystem interface {
  ...
  RollEventLeaderboard(ctx context.Context, logger runtime.Logger, nk runtime.NakamaModule, userID, teamID, eventLeaderboardID string, tier *int, matchmakerProperties, metadata map[string]interface{}) (eventLeaderboard *TeamEventLeaderboard, err error)
