...
type EventLeaderboardsSystem interface {
	...
	RollEventLeaderboard(ctx context.Context, logger runtime.Logger, nk runtime.NakamaModule, userID, eventLeaderboardID string, tier *int, matchmakerProperties, metadata map[string]interface{}) (eventLeaderboard *EventLeaderboard, err error)
